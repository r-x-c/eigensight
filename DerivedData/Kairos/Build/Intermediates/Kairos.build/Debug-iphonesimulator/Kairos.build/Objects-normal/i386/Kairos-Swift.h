...
- (void)viewDidLoad;
- (void)signInSignIn:(GIDSignIn * _Null_unspecified)signIn didSignInForUser:(GIDGoogleUser * _Null_unspecified)user withError:(NSError * _Null_unspecified)error;
...
- (void)signInSignIn:(GIDSignIn * _Null_unspecified)signIn presentViewController:(UIViewController * _Null_unspecified)viewController;
- (void)signInSignIn:(GIDSignIn * _Null_unspecified)signIn dismissViewController:(UIViewController * _Null_unspecified)viewController;
